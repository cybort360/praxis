// ai/openai.js — OpenAI provider (GPT-4o / GPT-4o-mini)
...
export class OpenAIProvider extends AIProvider {
  constructor(config) {
    ...
    this.model = config.model || 'gpt-4o-mini'; // cheap + fast for MVP
  ...
  // OpenAI uses the same prompt structure as Anthropic — delegate to shared logic.
  // We import the prompt builders from anthropic.js to avoid duplication.
  // The only difference is the _call() implementation above.
